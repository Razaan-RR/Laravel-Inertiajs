            ...
            <div class="collapse navbar-collapse justify-content-end custom-header-menu-icon" id="navbarSupportedContent">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a href="javascript:void(0)" class="nav-link" data-bs-toggle="modal" data-bs-target="#filterClient">
                        ...
                        <ul class="dropdown-menu shortcut overflow-hidden p-0">
                            ...
                            <li class="row m-0">
                                <div class="col-6 border text-center py-2">
                                    <a href="#">
                                        <p class="text m-0"><span class="material-symbols-outlined"> list </span></p>
                                        <p class="m-0 super-small"><small>Category</small> </p>
                                    </a>
                                </div>
                                <div class="col-6 border text-center py-2">
                                    <a href="#">
                                        <p class="text m-0"><span class="material-symbols-outlined"> medical_information </span></p>
                            ...
                            <li class="row m-0">
                                <div class="col-6 border text-center py-2">
                                    <a href="#">
                                        <p class="text m-0"><span class="material-symbols-outlined"> group </span></p>
                            ...
                            <li class="row m-0">
                                <div class="col-6 border text-center py-2">
                                    <a href="#">
                                        <p class="text m-0"><span class="material-symbols-outlined"> payments </span></p>
                                        <p class="m-0 super-small"><small>Payment Type</small> </p>
                                    </a>
                                </div>
                                <div class="col-6 border text-center py-2">
                                    <a href="#">
                                        <p class="text m-0"><span class="material-symbols-outlined"> meeting_room </span></p>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-bs-toggle="dropdown" href="#">
                            ...
                            <img src="{{ Auth::user()->image }}" alt="profile" class="rounded-circle" width="30" height="30">
                            @else
                            <img src="{{ asset('backend/template-assets') }}/images/avator.jpg" alt="profile" class="rounded-circle" width="30" height="30">
                            @endif
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('admin.profile') }}" class="d-flex align-items-center">
                                    @if(Auth::user()->image != null)
                                    <img src="{{ Auth::user()->image }}" class="rounded-circle me-2" alt="" width="30" height="30">
                                    @else
                                    <img src="{{ asset('backend/template-assets') }}/images/avator.jpg" class="rounded-circle me-2" alt="" width="30" height="30">
                                    @endif
